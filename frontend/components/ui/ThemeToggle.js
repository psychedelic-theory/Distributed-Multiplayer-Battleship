// ==========================================================================
// ThemeToggle — moon (dark mode) / sun (light mode) icon button
// ==========================================================================
...
export function ThemeToggle() {
  ...
  return h('button', {
    ...
    onClick: () => store.set({ theme: isDark ? 'light' : 'dark' }),
  },
    h('span', { class: 'theme-toggle__icon', html: isDark ? MOON_SVG : SUN_SVG }),
  );
}
